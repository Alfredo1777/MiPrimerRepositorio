...
def load_data():
    ...
    #with gzip.open('mnist.pkl.gz', 'rb') as file_contents:
     #   training_data, classification_data, test_data = pickle.load(file_contents, encoding='latin1')
